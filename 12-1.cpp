...
void traverse(string key, const unordered_map<string, vector<string> > adjacencyLists, set<string> little, vector<string> curPath, set<vector<string> > &paths) {
  ...
  for (string candidate : candidates) {
    ...
    traverse(candidate, adjacencyLists, set<string>(little), vector<string>(curPath), paths);
  }
...
int main(int argc, char **argv) {
  ...
  traverse("start", adjacencyLists, set<string>(), vector<string>(), paths);
